...
import org.firstinspires.ftc.teamcode.autonomous.Visuon as visuon


@TeleOp(name = "MTAT", group = "Linear OpMode")
class MTAT : LinearOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            for (det in detections!!) {
                ...
                if (det.id == visuon.tagid()) {
                    ...
                    targetDist = 0.0
                    bearing = 0.0
                    yaw = (det.id.toDouble() - visuon.tagid().toDouble()) * 30.0
                }
            }
